...
public class Country {
    ...
    public String getGovegnmetnFrom() {
        return govegnmetnForm;
    }

    public void setGovegnmetnFrom(String govegnmetnForm) {
        this.govegnmetnForm = govegnmetnForm;
    }
